...
provider "kubernetes" {
  host                   = "https://D268F67D5F556683F1DAA63FD99C7609.gr7.ap-southeast-1.eks.amazonaws.com"   # 从 AWS CLI 获取的 API 端点
  ...
  token                  = "k8s-aws-v1.aHR0cHM6Ly9zdHMuYW1hem9uYXdzLmNvbS8_"  # 从 AWS CLI 获取的认证令牌
}
